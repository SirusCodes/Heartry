...
class _Poem extends Table with TableInfo {
  ...
  GeneratedBoolColumn? _isSecret;
  GeneratedBoolColumn get isSecret => _isSecret ??= _constructIsSecret();
  GeneratedBoolColumn _constructIsSecret() {
    return GeneratedBoolColumn('is_secret', $tableName, false,
        defaultValue: const Constant(false));
  }

  @override
  List<GeneratedColumn> get $columns => [id, lastEdit, title, poem, isSecret];
  @override
